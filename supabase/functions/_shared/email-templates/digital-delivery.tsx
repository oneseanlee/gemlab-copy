...
export const DigitalDeliveryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your digital guides and community access are ready — download them now</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        {/* Heading */}
        <Heading style={h1}>Your Digital Guides Are Ready 🎉</Heading>

        <Text style={text}>
          Hey {firstName}, thank you for your order
          {orderId ? ` (#${orderId})` : ""}! Your bonus digital products are
          ready to access right now — no waiting required.
        </Text>
        ...
        <Text style={shippingNote}>
          📦 <strong>Your GLP-1 Protocol supplement is shipping separately</strong>{" "}
