...
const products = [
  ...
  },
  {
    id: 6,
    name: 'GLP-1 Activate',
    tags: [{ label: 'Preorder' }, { label: 'GLP-1 Companion' }],
    category: 'weight-loss',
    ribbon: 'NEW',
    bestFor: 'Sublingual cellular support designed specifically for GLP-1 therapy. Bypasses the gut, powers the burn, protects what GLP-1 strips away.',
    benefits: [
      'Bypasses the gut — absorbs in under 15 minutes',
      'Direct NAD+ fuels fat metabolism',
      'Protects muscle, bone & hormones',
    ],
    originalPrice: '$30',
    price: '$27',
    priceSuffix: '/mo',
  ...
  },
  {
    ...
    tags: [{ label: 'Bundle' }, { label: '4-Product System' }],
    category: 'systems',
    ribbon: 'BEST VALUE',
    bestFor: 'Complete 24-hour cellular optimization — 4 products working together for maximum results.',
    benefits: [
      'Activate365, Mito365, Restore365 & Metabolism+ included',
      '24-hour metabolic optimization cycle',
      ...
      <section className="b365-hero">
        <div className="b365-hero-container">
          <div className="b365-hero-image b365-parallax-hero" ref={parallaxRef}>
            <img src="/images/Best365_hero.png" alt="Athletic couple with Best 365 Labs products" fetchPriority="high" width="720" height="720" />
          </div>
